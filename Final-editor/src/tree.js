...
function TreeView(root, container, options) {
  ...
  function renderNode(node) {
    ...
    span_desc.addEventListener("click", function (e) {
      ...
      if (node_cur.isLeaf()) {
        ...
        fetch(new Request(`http://localhost:3002/file?file=${fullPath}`, myInit))
          ...
          .then(text => {
            ...
            const mode = modelist.getModeForPath(relPath)
            console.log('tree.js[185] mode:', mode)
      ...
      // console.log('tree.js[163] clicked', new TreePath(node_cur.getRoot(), node_cur).toCompleteString());
