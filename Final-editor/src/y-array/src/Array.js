...
function extend (Y) {
  class YArray extends Y.utils.CustomType {
    ...
    insert (pos, contents) {
      console.log('Array.js[175]', 'start insert', pos, contents, this.os.requestTransaction);
      ...
      this.os.requestTransaction(function *() {
        ...
        console.log('Array.js[247]',this.applyCreatedOperations);
