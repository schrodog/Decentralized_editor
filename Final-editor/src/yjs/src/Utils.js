  ...
  class EventHandler extends EventListenerHandler {
    ...
    */
    ...
    /*
      ...
      called right away. Received operations will not be executed until all
      prematurely called operations are executed
    */
    awaitAndPrematurelyCall (ops) {
      console.log('Util.js[279]','awaitAndPremat',ops);
      this.awaiting++
    ...
    * awaitOps (transaction, f, args) {
      ...
      console.log('Util.js[382]','got utils',transaction, f, args)
      // if (ops[0].struct === 'Cursor') {
      // }
    }
